...
void GPU::drawPixel(Uint16 x, Uint16 y, Uint32 color)
{
...
void GPU::resize(int w, int h) {
    ...
    int newPixelWidth = windowWidth / GPU::NATIVE_WIDTH;
    int newPixelHeight = windowHeight / GPU::NATIVE_HEIGHT;
    ...
    this->gameWidth = this->pixelWidth * GPU::NATIVE_WIDTH;
    this->gameHeight = this->pixelHeight * GPU::NATIVE_HEIGHT;
}
...
Uint8 GPU::readByte(Uint16 addr) { return 0; }
void GPU::writeByte(Uint16 addr, Uint16 value) {}
void GPU::updateTile(Uint16 addr, Uint32 value) {}
void GPU::updateOam(Uint16 addr, Uint32 value) {}